...
INPUT_DIR="/mnt/x/PROJECTS_2/Big_Island/ChangeHI_Trees/Dry_Forest/Data/Raster/unaligned_groups/group13"
OUTPUT_DIR="/home/manumea/Projects/DryForest/group13"
FORCE="${FORCE:-0}"
